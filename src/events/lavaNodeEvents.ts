...
export default async (client: BotClient) => {
    client.lavalink.nodeManager
        ...
        .on("destroy", (node: LavalinkNode, destroyReason: unknown) => {
            client.warn(
        ...
        .on("disconnect", (node: LavalinkNode, reason: { code?: number; reason?: string }) => {
            client.warn(
        ...
        .on("resumed", (node: LavalinkNode, payload: unknown) => {
        ...
        .on("raw", (node: LavalinkNode, payload: unknown) => {
