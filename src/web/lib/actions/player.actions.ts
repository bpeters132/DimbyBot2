...
import type { PlayerStateResponse, QueueResponse } from "@/types/web"
import {
...
async function readPlayerStateResult(res: Response): Promise<Ok<PlayerStateResponse> | Err> {
    return parseBotApiActionResponse<PlayerStateResponse>(res)
}

async function readQueueResult(res: Response): Promise<Ok<QueueResponse> | Err> {
    return parseBotApiActionResponse<QueueResponse>(res)
}
