...
module.exports = class UrbanCommand extends (
    ...
    constructor(client) {
        super(client, {
            ...
            memberName: "urban",
            description:
                "Looks up the urban dictionary definition of a word or phrase.",
            args: [
                {
                    key: "word",
                    prompt:
                        "You need to specify a word or phrase for me to look up",
                    type: "string",
                },
            ],
        });
    ...
    async run(message, { word }) {
        ...
        request.end(function (response) {
            ...
            try {
                var final_response = response.body["list"][0]["definition"]
                    .replace(/\[/g, "")
                    .replace(/\]/g, "");
            } catch (error) {
                message.reply(
                    "There was no definition found for your term.. try again."
                );
            }
